...
@pytest.fixture
def polling_service(telegram_adapter):
    """Create TelegramPollingService instance."""
    return TelegramPollingService(telegram_adapter, poll_interval=1, timeout=30)

class TestTelegramPollingService:
    """Test suite for TelegramPollingService."""
    
    def test_initialization(self, polling_service, telegram_adapter):
    ...
    def test_stats_initialization(self, polling_service):
    ...
    def test_get_updates_success(self, mock_post, polling_service):
    ...
    @patch('aos.adapters.telegram_polling.requests.post')
    def test_get_updates_empty(self, mock_post, polling_service):
    ...
    @patch('aos.adapters.telegram_polling.requests.post')
    def test_get_updates_api_error(self, mock_post, polling_service):
    ...
    @patch('aos.adapters.telegram_polling.requests.post')
    def test_get_updates_timeout(self, mock_post, polling_service):
    ...
    def test_process_message_update(self, polling_service, telegram_adapter):
    ...
    def test_process_callback_update(self, polling_service, telegram_adapter):
        ...
        telegram_adapter.handle_callback.assert_called_once_with(123, 456, 'harvest_maize')
    
    def test_process_update_error_handling(self, polling_service, telegram_adapter):
    ...
    def test_stop_polling(self, polling_service):
    ...
    def test_get_status(self, polling_service):
